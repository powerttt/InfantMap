...
//                不包含站点信息，先保存数据
            SaveSiteUtil.saveInRedis(siteNameMap,"siteNameMap");
...
//                包含起始 终点，赋值
            ...
            System.out.println(originSet.isEmpty()?"originSet赋值成功":"originSet为空");
            System.out.println(endSet.isEmpty()?"endSet赋值成功":"endSet为空");
            return pathSearch();
        }
    }
...
//        下一站的车次集合(中介)
        ...
        //取出其中的交集
        Set<Integer> nonstopSet = (HashSet<Integer>) CollectionUtils.intersection(originSet, endSet);
